...
read_verilog -netlist ../tsdb_outdir/dft_inserted_designs/croc_soc_gate1.dft_inserted_design/croc_soc.vg

current_design croc_soc
source ../3.synthesize_rtl/croc_soc.sdc
...
write -f verilog -hierarchy -output croc_soc_layout.vg
